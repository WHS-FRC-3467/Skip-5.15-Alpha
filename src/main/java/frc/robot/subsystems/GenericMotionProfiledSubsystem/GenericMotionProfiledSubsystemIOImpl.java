...
public class GenericMotionProfiledSubsystemIOImpl implements GenericMotionProfiledSubsystemIO {
        ...
        GenericMotionProfiledSubsystemConstants constants, boolean isSim)
    {
        ...
        mMainMotor =
            new TalonFX(mConstants.kLeaderMotor.getDeviceNumber(),
                mConstants.kLeaderMotor.getBus());
        ...
        if (mConstants.kFollowMotor != null) {
            ...
            mFollower.setControl(
                new Follower(mConstants.kLeaderMotor.getDeviceNumber(),
                    mConstants.kFollowerOpposesMain));
        }
    ...
    public void updateInputs(GenericMotionProfiledIOInputs inputs)
    {
        ...
        if (mConstants.kCANcoder != null) {
            ...
            inputs.absoluteEncoderPositionRot =
                mEncoderAbsolutePositionRotations.getValueAsDouble();
            inputs.relativeEncoderPositionRot =
                mEncoderRelativePositionRotations.getValueAsDouble();
        }
    ...
    {
        if (amps >= 0) {
            mMainMotor.setControl(currentControl.withOutput(amps).withMaxAbsDutyCycle(0.07));
        } else {
            mMainMotor.setControl(currentControl.withOutput(amps).withMaxAbsDutyCycle(0.6));
        }
