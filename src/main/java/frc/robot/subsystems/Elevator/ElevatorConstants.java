...
public final class ElevatorConstants {
    ...
    static {
        ...
        kSubSysConstants.kMotorConfig.Slot0.kP = 12;
        ...
        kSubSysConstants.kMotorConfig.Slot0.kG = .33;
        kSubSysConstants.kMotorConfig.Slot0.kS = .2;
        kSubSysConstants.kMotorConfig.Slot0.kV = 1.1;
        kSubSysConstants.kMotorConfig.Slot0.kA = .2;
        kSubSysConstants.kMotorConfig.MotionMagic.MotionMagicCruiseVelocity = 20;
        kSubSysConstants.kMotorConfig.MotionMagic.MotionMagicAcceleration = 5;
