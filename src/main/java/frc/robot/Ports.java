...
public class Ports {
   ...
   *
   * public static final CanDeviceId ELEVATOR_MAIN = new CanDeviceId(13, "canivore1"); public static
   * final CanDeviceId ELEVATOR_FOLLOWER = new CanDeviceId(14, "canivore1");
   *
   ...
   *
   * public static final CanDeviceId CLIMBER_MAIN = new CanDeviceId(18, "canivore1"); public static
   * final CanDeviceId CLIMBER_FOLLOWER = new CanDeviceId(19, "canivore1");
   *
  ...
  /*
   * public static final int SERIALIZER_BREAK = 7; public static final int FEEDER_BREAK = 8; public
   * static final int AMP_BREAK = 9;
   */
