...
import frc.robot.subsystems.Climber.Climber.State;
...
public class RobotContainer {
    ...
    public final Climber m_profiledClimber;
        ...
        m_driver
            ...
            .onTrue(
                Commands.runOnce(
                    ...
                    }).andThen(m_profiledClimber.setStateCommand(State.HOME)));
