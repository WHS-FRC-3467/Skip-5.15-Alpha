...
public class Ports {
  ...
  /*
   * public static final CanDeviceId INTAKE_PIVOT = new CanDeviceId(8,
   * "canivore1");
   * public static final CanDeviceId INTAKE_ROLLER = new CanDeviceId(15, "rio");
   *
   * public static final CanDeviceId SERIALIZER = new CanDeviceId(10,
   * "canivore1");
   ...
   *
   * public static final CanDeviceId ELEVATOR_MAIN = new CanDeviceId(13,
   * "canivore1");
   * public static final CanDeviceId ELEVATOR_FOLLOWER = new CanDeviceId(14,
   * "canivore1");
   *
   * public static final CanDeviceId SHOOTER_TOP = new CanDeviceId(15,
   * "canivore1");
   * public static final CanDeviceId SHOOTER_BOTTOM = new CanDeviceId(16,
   * "canivore1");
   *
   * public static final CanDeviceId HOOD = new CanDeviceId(17, "canivore1");
   * public static final CanDeviceId HOOD_CANCODER = new CanDeviceId(5,
   * "canivore1");
   *
   * public static final CanDeviceId CLIMBER_MAIN = new CanDeviceId(18,
   * "canivore1");
   * public static final CanDeviceId CLIMBER_FOLLOWER = new CanDeviceId(19,
   * "canivore1");
   *
