...
public class Constants {
  ...
  /*
   * public static final class DriveConstants { public static final double headingAngleTolerance =
   * 2.0; public static final double MaxSpeed = 4.70; // TunerConstants.kSpeedAt12VoltsMps; //
   * kSpeedAt12VoltsMps desired top speed public static final double MaxAngularRate = 1.5 * Math.PI;
   * // 3/4 of a rotation per second max angular velocity
   * 
   * public static TalonFXConfiguration motorConfig() { TalonFXConfiguration m_configuration = new
   ...
   * return m_configuration; }
   * 
   * public static TalonFXConfiguration motor2Config() { TalonFXConfiguration m_configuration =
   * motorConfig(); m_configuration.MotorOutput.Inverted = InvertedValue.Clockwise_Positive; return
   * m_configuration; } }
   */
  ...
  public static class FieldConstants {
    ...
    public static final Pose2d RED_AMP = new Pose2d(Units.inchesToMeters(578.77),
        Units.inchesToMeters(323.00), new Rotation2d(-Math.PI / 2));
    public static final double BLUE_AUTO_PENALTY_LINE = 9; // X distance from origin to center of
                                                           // the robot almost fully crossing the
                                                           // midline
    public static final double RED_AUTO_PENALTY_LINE = 7.4; // X distance from origin to center of
                                                            // the robot almost fully crossing the
                                                            // midline
