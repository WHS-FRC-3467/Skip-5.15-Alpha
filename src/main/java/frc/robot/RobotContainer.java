...
public class RobotContainer {
        ...
        private final ProfiledClimber m_profiledClimberSubsystem;
        ...
        public RobotContainer() {
                ...
                switch (Constants.currentMode) {
                        case REAL:
                                ...
                                m_profiledClimberSubsystem = new ProfiledClimber(new ProfiledClimberIOTalonFX(), false);
                                break;
                        ...
                        default:
                                ...
                                m_profiledClimberSubsystem = new ProfiledClimber(new ProfiledClimberIO() {
                                }, true);
                                break;
                }
        ...
        private void configureControllerBindings() {
                 ...
                 * .leftBumper()
                 * .whileTrue(
                 * m_sampleProfiledRollerSubsystem.setStateCommand(SampleProfiledRoller.State.
                 * EJECT));
                 * m_driver
                 * .rightBumper()
                 * .whileTrue(
                ...
                m_driver
                                ...
                                .onTrue(
                                                Commands.parallel(
                                                                m_sampleArmSubsystem.setStateCommand(
                                                                                SampleProfiledArm.State.HOME),
                                                                m_sampleElevatorSubsystem.setStateCommand(
                                                                                SampleProfiledElevator.State.HOME)));
                ...
                m_driver
                                ...
                                .onTrue(
                                                Commands.parallel(
                                                                m_sampleArmSubsystem.setStateCommand(
                                                                                SampleProfiledArm.State.LEVEL_1),
                                                                m_sampleElevatorSubsystem.setStateCommand(
                                                                                SampleProfiledElevator.State.LEVEL_1)));
                ...
                m_driver
                                ...
                                .onTrue(
                                                Commands.parallel(
                                                                m_sampleArmSubsystem.setStateCommand(
                                                                                SampleProfiledArm.State.LEVEL_2),
                                                                m_sampleElevatorSubsystem.setStateCommand(
                                                                                SampleProfiledElevator.State.LEVEL_2)));
                ...
                m_driver
                                ...
                                .onTrue(
                                                Commands.parallel(
                                                                m_sampleArmSubsystem.setStateCommand(
                                                                                SampleProfiledArm.State.LEVEL_3),
                                                                m_sampleElevatorSubsystem.setStateCommand(
                                                                                SampleProfiledElevator.State.LEVEL_3)));
