...
public class RobotContainer {
    ...
    public RobotContainer()
    {
        switch (Constants.currentMode) {
            ...
            default:
                ...
                m_vision =
                    new Vision(m_drive::addVisionMeasurement, new VisionIO() {}, new VisionIO() {});
    ...
    private void configureControllerBindings()
    {
        ...
        m_operator.x()
            .whileTrue(m_sampleRollersSubsystem.setStateCommand(SampleRollers.State.EJECT));
        // Operator Y Button: Run the Sample Roller in Intake direction when held
        m_operator.y()
            .whileTrue(m_sampleRollersSubsystem.setStateCommand(SampleRollers.State.INTAKE));
    }
