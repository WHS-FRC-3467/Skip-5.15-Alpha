...
public class Arm extends GenericMotionProfiledSubsystem<Arm.State> {
    ...
    public enum State implements TargetState {
        ...
        CORAL_INTAKE(() -> Units.degreesToRotations(135.78), ProfileType.MM_POSITION),
        LEVEL_1(() -> Units.degreesToRotations(127.0), ProfileType.MM_POSITION),
        LEVEL_2(() -> .2751, ProfileType.MM_POSITION),
        LEVEL_3(() -> 0.295, ProfileType.MM_POSITION),
        ...
        ALGAE_LOW(() -> .2377, ProfileType.MM_POSITION),
        ALGAE_HIGH(() -> .2446, ProfileType.MM_POSITION),
        ALGAE_GROUND(() -> Units.degreesToRotations(70.0), ProfileType.MM_POSITION),
        ALGAE_SCORE(() -> Units.degreesToRotations(127.18), ProfileType.MM_POSITION),
